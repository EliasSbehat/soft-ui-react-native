...
const DrawerContent = (
  ...
  const screens = [
    {name: 'Collectables', to: 'Gallery', icon: assets.star},
    {name: 'Transactions', to: 'Transactions', icon: assets.components},
    {name: 'Payments', to: 'Payments', icon: assets.check},
    {name: t('screens.settings'), to: 'Settings', icon: assets.settings},
    {name: t('screens.components'), to: 'Components', icon: assets.components},
    {name: 'Logout', to: 'Login', icon: assets.users},
  ];
